...
#
#
#y_pred = abc.predict([[9,3,3212.49,305,7786,4573.51,13687,0,0,0]])
#
#print(y_pred)
#print()
#
...
if y_pred==0:
    print("This is UPI Non Fraud")
else:
  print("This is UPI Fraud")
  print()
print("#--------------------Camparision batween 3 Algorithm Accuracy---------------#")
print("*******************")
print()
#print(acc1)
#print(acc2)
...
df_plot  = pd.DataFrame([acc1,acc2,acc3])
df_plot.index=['Random Forest','KNN','Ada Boost']
